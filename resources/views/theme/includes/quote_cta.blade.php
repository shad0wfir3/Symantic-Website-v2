        ...
        <div class="row">
            <div class="col-md-9">
                <div class="call-box-3 text-center text-md-left">
                    <h5 class="mt-3">Interested in our {{ strtolower($service->name) }} services? Want to work with us?</h5>
                    <p class="mb-0">Fill in our easy to use quote form and let us help you grow.</p>
                </div>
            </div>
