            ...
            <div class="row">
                <div class="col-md-7 parallax-fade-top">
                    <div class="main-title on-dark text-left mb-0">
                        <h2><mark>Strategic Market Consulting</mark></h2></h2>
                        <div class="main-subtitle-bottom mt-4">A short description about strategic marketing consulting</div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
