        ...
        <div class="row">
            <div class="col-md-9">
                <div class="call-box-3 text-center text-md-left dark">
                    <h5 class="mb-3 color-white">Discover Symantic Business Development Services (SBDS) &trade;</h5>
            ...
            <div class="col-md-3 mt-4 mt-md-0">
                <div class="call-box-3 text-center text-md-right">
                    <a href="{{ route('sbds') }}" class="btn btn-primary btn-simple btn-round btn-long mt-0 mt-md-4" >discover SBDS &trade;</a>
                </div>
            </div>
        </div>
    </div>
