            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        Posts
                        <a href="{{ route('blog.create') }}" class="btn btn-primary float-md-right">Create New</a>
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span><a href="{{ route('blog.edit',$post->id) }}" class="btn btn-primary flex-last"><i class="fa fa-edit"></i></a></span>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
